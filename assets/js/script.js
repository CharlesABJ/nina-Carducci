...
const imagesToModal = document.querySelectorAll(".gallery picture img");
...
//Cloner l'image cliquée dans la modale

 const imageOfModal = document.createElement("img");
 modal.append(imageOfModal);

for (let image of imagesToModal) {
